<nav class="navbar navbar-expand-lg navbar-dark bg-black fixed-top">
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                ...
                <a href="https://play.google.com/store/apps/details?id=br.com.devbase.zippa&hl=pt_BR" target="_blank" class="btn btn-outline-warning">
                    <i class="fas fa-download me-2"></i> BAIXAR APLICATIVO
                </a>
            </div>
        </div>
    </nav>  