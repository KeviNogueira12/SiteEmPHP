    ...
    <div class="hero-section" style="background-color: #f8f9fa;">
        <div class="container py-5">
            <div class="row align-items-center">
                <div class="col-lg-6">
                     <h1 class="display-4 fw-bold mb-4" style="color: #ED5E0C;">Viaje com conforto e segurança</h1>
                    <p class="lead mb-4">O ZIPPA leva você a qualquer lugar com motoristas verificados e veículos confortáveis.</p>
                </div>
                <div class="col-lg-6">
                    <img id="bannerpassageiro" src="../imagens/banner44.png" alt="Passageiro ZIPPA" class="img-fluid rounded shadow">
                </div>
            </div>
        </div>
    </div>
...
<div class="col-md-4">
  ...
  <div class="col-md-6">
    ...
    <div class="invalid-feedback">Por favor, informe um CPF válido (11 números).</div>
    <div class="valid-feedback">Tudo certo!</div>
  </div>
...
document.getElementById('tipoUsuario').innerHTML += tiposUsuario.map(tipo => `<option>${tipo}</option>`).join('');
 ...
 <!-- vantagens -->
    <div class="container my-5 py-4">
        <h2 class="text-center mb-5 fw-bold" style="color: #ED5E0C;">Por que escolher o ZIPPA?</h2>
            ...
            <div class="row g-4">
                ...
                <div class="col-md-3">
                    <div class="text-center">
                        ...
                        <h5 class="mt-2">Solicite sua viagem</h5>
                ...
                <div class="col-md-3">
                    <div class="text-center">
                        ...
                        <h5 class="mt-2">Acompanhe em tempo real</h5>
